  ...
  theme: {
    extend: {
      colors: {
        ...
        warning: {
          50: 'oklch(0.985 0.017 58 / <alpha-value>)',
          100: 'oklch(0.962 0.041 58 / <alpha-value>)',
          200: 'oklch(0.924 0.078 58 / <alpha-value>)',
          300: 'oklch(0.869 0.126 58 / <alpha-value>)',
          400: 'oklch(0.769 0.155 58 / <alpha-value>)',
          500: 'oklch(0.666 0.157 58 / <alpha-value>)',
          600: 'oklch(0.578 0.141 58 / <alpha-value>)',
          700: 'oklch(0.489 0.119 58 / <alpha-value>)',
          800: 'oklch(0.424 0.099 58 / <alpha-value>)',
          900: 'oklch(0.379 0.083 58 / <alpha-value>)',
        },
        info: {
          50: 'oklch(0.97 0.014 254 / <alpha-value>)',
          100: 'oklch(0.932 0.032 255 / <alpha-value>)',
          200: 'oklch(0.882 0.059 254 / <alpha-value>)',
          300: 'oklch(0.809 0.105 251 / <alpha-value>)',
          400: 'oklch(0.707 0.165 254 / <alpha-value>)',
          500: 'oklch(0.623 0.214 259 / <alpha-value>)',
          600: 'oklch(0.546 0.245 262 / <alpha-value>)',
          700: 'oklch(0.488 0.243 264 / <alpha-value>)',
          800: 'oklch(0.424 0.199 265 / <alpha-value>)',
          900: 'oklch(0.379 0.146 265 / <alpha-value>)',
        },
        error: {
