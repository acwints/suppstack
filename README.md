...
The canonical product, architecture, customer-journey, data-integrity, telemetry,
and progress document is [`CONTEXT.md`](CONTEXT.md). Update it with every material
behavior or data-model change.
