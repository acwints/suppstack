...
const curatedProductSeeds: CuratedProductSeed[] = [
  ...
  },
  {
    ...
    product_name: 'Grass-Fed Whey Protein Isolate',
    product_description:
      'Bare Performance Nutrition whey isolate for lifters comparing clean protein tubs, flavor choices, and direct Shopify restocks.',
    product_price: 59.99,
  ...
  },
  {
    ...
    product_description:
      'Naked Mass large-format mass gainer for bulking stacks, calorie-surplus plans, and protein-carb refill routines.',
    product_price: 69.99,
    ...
    ucp_enabled: true,
    inventory_status: 'in_stock',
    quality_badges: ['Mass gainer', 'Shopify UCP', 'Bulking stack'],
    subscriptions_available: true,
    data_source: 'manual',
  },
  {
  ...
  },
  {
    ...
    product_description:
      'Citrulline powder for pump-focused gym stacks, pre-workout add-ons, and shoppers comparing direct brand-cart performance basics.',
    product_price: 15,
