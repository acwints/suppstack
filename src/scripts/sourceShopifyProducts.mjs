...
const STORES = [
  ...
  { domain: 'pioneerpastures.com', brandId: 'pioneer-pastures', brandName: 'Pioneer Pastures' },
  { domain: 'davidprotein.com', brandId: 'david-protein', brandName: 'David Protein' },
  { domain: 'armra.com', brandId: 'armra', brandName: 'ARMRA' },
  { domain: 'cowboycolostrum.com', brandId: 'cowboy-colostrum', brandName: 'Cowboy Colostrum' },
  { domain: 'www.bareperformancenutrition.com', brandId: 'bare-performance-nutrition', brandName: 'Bare Performance Nutrition' },
  { domain: 'us.foursigmatic.com', brandId: 'four-sigmatic', brandName: 'Four Sigmatic' },
  { domain: 'ancestralsupplements.com', brandId: 'ancestral-supplements', brandName: 'Ancestral Supplements' },
  { domain: 'dosedaily.co', brandId: 'dose-daily', brandName: 'Dose Daily' },
  { domain: 'www.vitalproteins.com', brandId: 'vital-proteins', brandName: 'Vital Proteins' },
